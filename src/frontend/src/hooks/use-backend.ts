...
const defaultIndustries: Industry[] = [

  {
    ...
    description:
      "Our flagship expertise. We build comprehensive commission engines, distributor back-offices, genealogy trees, and replicated websites that power global networks of independent business owners.",
    iconName: "Network",
    slug: "direct-selling",
    sortOrder: 1n,
  ...
  },
  {
    ...
    description:
      "Modern commerce solutions that convert. From bespoke Shopify storefronts to complex marketplace integrations and subscription-based retail models.",
    iconName: "ShoppingCart",
    slug: "ecommerce",
    sortOrder: 2n,
    highlights: ["Shopify Plus", "Marketplace Sync", "Subscription Commerce"],
    featured: true,
  },
  {
    id: 3n,
    ...
    description:
      "Transforming the wellness industry with technology. We build secure patient portals, habit-tracking apps, and specialized platforms for wellness-focused direct selling brands.",
    iconName: "HeartPulse",
  ...
  },
  {
    ...
    description:
      "Tailored solutions for high-growth beauty and supplement brands. Inventory management, influencer tracking, and specialized product catalog engines.",
    iconName: "Sparkles",
    slug: "beauty-supplements",
    sortOrder: 4n,
    highlights: ["Product Catalogs", "Influencer Tools", "Inventory Sync"],
    featured: false,
  },
  {
    id: 5n,
    ...
    description:
      "Secure, compliant platforms for investment firms and fintech innovators. Building trust through bulletproof security and intuitive user experiences.",
    iconName: "Landmark",
    slug: "financial-services",
    sortOrder: 5n,
    highlights: ["Fintech Apps", "Security Compliance", "Dashboards"],
    featured: false,
  },
  {
    id: 6n,
    ...
    description:
      "Digital transformation for consultancies and service firms. Workflow automation, HubSpot implementations, and custom client portals.",
    iconName: "Users",
    slug: "professional-services",
    sortOrder: 6n,
    highlights: ["HubSpot Setup", "Client Portals", "Workflow Automation"],
    featured: false,
  },
  {
    id: 7n,
    ...
    description:
      "Scalable learning experiences. We build custom LMS platforms, course delivery systems, and certification tracking for modern educators.",
    iconName: "GraduationCap",
    slug: "education-elearning",
    sortOrder: 7n,
    highlights: ["Custom LMS", "Course Delivery", "Certification"],
    featured: false,
  },
];
