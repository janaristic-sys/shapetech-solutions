...
const defaultSolutions: Solution[] = [
  {
    id: 1n,
    title: "Crunchi",
    tagline: "EWG-Verified Clean Beauty on Shopify",
    description: "Crunchi is an EWG-Verified clean beauty and skincare brand operating on the Shopify Platform. Because Crunchi utilizes an 'Advocate' network (Direct-sales/Affiliate marketing model), accurate tracking of sales attribution is vital. ShapeTech designed and built a seamless, real-time data integration connecting Crunchi's Shopify storefront to BDT, their third-party commission and MLM engine. ShapeTech built a custom integration middleware that bridges the gaps between e-commerce behavior and complex commission logic.",
    iconName: "Sparkles",
    slug: "crunchi",
    sortOrder: 1n,
    features: ["Integration Middleware", "Webhook Architecture", "Data Transformation Layer", "High-Volume Scalability"],
    relatedShapeIds: [4n],
    caseStudy: {
      title: "Real-time Data Integration Middleware",
      description: "Designed a seamless, real-time data integration connecting Crunchi's Shopify storefront to BDT, their third-party commission and MLM engine.",
      metrics: [],
    },
