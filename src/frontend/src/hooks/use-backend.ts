...
const defaultSolutions: Solution[] = [
  ...
  },
  {
    ...
    description: "A subscription-based commerce and coaching platform for FASTer Way to Fat Loss, managing high-volume recurring orders, cohort billing, and a seamless customer experience at scale.",
    iconName: "RefreshCcw",
    slug: "faster-way",
    sortOrder: 4n,
