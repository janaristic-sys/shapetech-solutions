...
const defaultClients: Client[] = [
  ...
  { id: 7n, name: "Sannavita", logoUrl: "", websiteUrl: "https://sannavita.com", sortOrder: 7n, solutionSlug: "sannavita" },
...
const defaultSolutions: Solution[] = [
  {
    id: 1n,
    title: "Crunchi",
    tagline: "Affiliate Storefront & Attribution Engine",
    description: "A high-conversion Shopify Plus storefront built for Crunchi's affiliate-driven skincare brand, with a custom attribution engine that tracks every rep's sales accurately.",
    iconName: "Sparkles",
    slug: "crunchi",
    sortOrder: 1n,
  ...
  },
  {
    id: 2n,
    title: "NewULife",
    tagline: "Direct Selling Platform & Back-Office",
    description: "A complete direct selling platform for NewULife, including a distributor back-office, commission engine, and replicated website system for their growing field organization.",
    iconName: "Users",
    slug: "newulife",
    sortOrder: 2n,
    features: ["Distributor back-office", "Commission engine", "Replicated sites", "Field dashboards"],
    relatedShapeIds: [3n],
    caseStudy: {
      title: "Direct Selling Infrastructure",
      description: "Built the full back-office and compensation infrastructure powering NewULife's distributor network.",
      metrics: [],
    },
  },
  {
    ...
    description: "A real-time commission engine and distributor portal for Nuvita's nutraceutical sales network, giving distributors full visibility into their business at all times.",
    iconName: "HeartPulse",
    slug: "nuvita",
    sortOrder: 3n,
  ...
  },
  {
    ...
    description: "A subscription-based commerce and coaching platform for Faster Way, managing high-volume recurring orders, cohort billing, and a seamless customer experience at scale.",
    iconName: "RefreshCcw",
    slug: "faster-way",
    sortOrder: 4n,
    ...
    caseStudy: {
      ...
      description: "Built the subscription engine powering Faster Way's high-volume coaching and wellness program.",
      metrics: [],
    },
  },
  {
    ...
    description: "A full direct-selling platform for Wine Shop at Home, with multi-tier commission structures, replicated consultant websites, and a complete back-office for thousands of independent reps.",
    iconName: "Users",
  ...
  },
  {
    ...
    description: "A multi-country e-commerce platform for Reliv with a global points e-wallet system, enabling seamless redemption across regions with automatic currency and tax handling.",
    iconName: "Globe",
    slug: "reliv",
    sortOrder: 6n,
  ...
  },
  {
    ...
    description: "A commerce and distribution platform built for Sannavita's wellness product line, handling direct sales, distributor management, and subscription orders from a single system.",
    iconName: "HeartPulse",
    slug: "sannavita",
    sortOrder: 7n,
    ...
    caseStudy: {
      ...
      description: "Built the unified commerce and distribution platform for Sannavita's wellness product catalog.",
      metrics: [],
    },
  },
  {
    ...
    description: "A clean, high-performance direct selling storefront and back-office solution for Li Bri, built to support their affiliate model and growing customer base.",
    iconName: "Sparkles",
    slug: "li-bri",
    sortOrder: 8n,
