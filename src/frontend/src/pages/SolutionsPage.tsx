...
function SolutionSkeleton() {
  return (
    <div className="card-fluid p-5 md:p-8 flex flex-col justify-between min-h-[380px]">
      <div>
...
export default function SolutionsPage() {
  ...
  return (
    <div data-ocid="solutions.page">
      ...
      <section className="bg-background py-12 md:py-16 min-h-[300px] md:min-h-[500px]" data-ocid="solutions.database_grid">
                ...
                {filteredSolutions.map((sol, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-5 md:p-8 pt-0 md:pt-0 mt-auto">
