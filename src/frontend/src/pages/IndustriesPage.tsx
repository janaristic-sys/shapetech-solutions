  ...
  return (
    <div data-ocid="industries.page">
      ...
      >
        ...
        <div className="relative container max-w-7xl mx-auto px-4 sm:px-6 lg:px-10">
          <motion.div
          ...
          >
            ...
            <h1 className="font-display font-bold text-4xl md:text-6xl text-foreground leading-[1.05] mb-6">
      ...
      >
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-10">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
